...
import fr.redblock.doors.commands.doorsCommand;
import fr.redblock.doors.events.mainListeners;
...
public class Core extends JavaPlugin {
	...
	public void onEnable() {
		...
		pm.registerEvents(new mainListeners(this), this);
		getCommand("doors").setExecutor(new doorsCommand(this));
		saveDefaultConfig();
	}
