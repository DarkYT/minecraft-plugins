package fr.endwork.gotuhc.team;
...
import fr.endwork.gotuhc.event.player.team.PlayerJoinTeamEvent;
import fr.endwork.gotuhc.event.player.team.PlayerLeaveTeamEvent;
...
public class Team {
  ...
  public Team(Player leader) {
    ...
    GameCore.getCurrentGame().getTeams().add(this);
  }
  ...
  public boolean disband() {
    ...
    return GameCore.getCurrentGame().getTeams().remove(this);
  }
  ...
  public static void checkToModify() throws BusyGameStateException, InvalidGameStateException {
    Game game = GameCore.getCurrentGame();
