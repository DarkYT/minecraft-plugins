...
public class Core extends JavaPlugin {
	...
	public void onEnable(){
		if (!setupEconomy()){
			getLogger().severe(String.format("[%s] - Vault est absent ! D̩sactivation...", getDescription().getName()));
	...
	public void confirmCor(Player p){
		Inventory corrompu  = Bukkit.createInventory(null, 9, ChatColor.translateAlternateColorCodes('&', "&8&lAcheter le grade Corrompu")); //M̻me noms et tu fais pour le vampire, comme moi
